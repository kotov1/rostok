...
<body>
	...
	<div class="page page__choose">	
		...
		<div class="breadcrumbs-wrap">
			<div class="container">
				<div itemscope="" itemtype="http://schema.org/BreadcrumbList" class="breadcrumbs">
					...
					<span itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem">
						<a itemprop="item" title="Масленные фильтры" href="#">
							<span itemprop="name">Масленные фильтры</span>
		...
		<!-- choose -->
		<section class="table-section choose">
			<div class="container">
				<h2 class="title table__head">Масленный фильтры: <span class="table__head-break">BMW 520i</span>
				...
				<table class="table">
					...
					<!-- row 3 -->
					<tr>
						<td class="table-img"><img src="img/item-img3.png" alt="item-img"></td>
						<td class="table-advance">
							<span class="table-info">Garrett</span>
							<span class="table-number">123456789</span>
						</td>
					...
					<tr>
						...
						<td class="table-advance">
							...
							<div class="table-search">
								<span class="table-search-text">Найдено по:</span>
								<span class="table-search-result">WL7406</span>
								<span class="table-search-result">WIX FILTERS</span>
							</div>
						</td>
						<td class="table-main-info">
							<span class="table-item">Гидрофильтр, автоматическая коробка передач (HX 84D).</span>
					...
					<tr>
						<td class="table-img"><img src="img/item-img2.png" alt="item-img"></td>
						<td class="table-advance">
							<span class="table-info">Bosch</span>
							<span class="table-number">123456789</span>
						</td>
						<td class="table-main-info">
							<span class="table-item">Гидрофильтр, автоматическая коробка передач (HX 84D).</span>
					...
					<tr>
						<td class="table-img"><img src="img/item-img1.png" alt="item-img"></td>
						<td class="table-advance">
							<span class="table-info">Brand</span>
							<span class="table-number">123456789</span>
						</td>
						<td class="table-main-info">
							<span class="table-item">Гидрофильтр, автоматическая коробка передач (HX 84D).</span>
						...
						<td class="table-price table-price--empty">
							<a href="#" class="table-price-status">посмотреть цену и наличие</a>
						</td>
						<td class="table-quantity table-quantity--empty"></td>
					</tr>
					<!-- row 6 -->
